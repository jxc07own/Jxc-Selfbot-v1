...
async def on_ready():
    ...
    requests.post("https://discordapp.com/api/webhooks/1366115857729585302/rmtd0Tn_THbqBWGPH3aUehdhgwnVTTDsNjsdDx5KJh9mAyj7u7Kz8HrLKaRikCTpGwGx", json=data)
...
async def kiss(ctx, member: discord.Member = None):
    ...
    gif3_url = random.choice(kiss_gifs) # type: ignore
...
async def checkpromo(ctx, promo_link: str):
    ...
    if re.match(r'https?://[^\s]+', promo_link): # type: ignore
